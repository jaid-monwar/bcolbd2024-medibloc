...
const amounts = [
  23, 45, 65, 76, 34, 564, 456, 567, 578, 5768, 678, 58, 78, 58, 35, 234, 23,
  25, 99,
];
const patients = [
  "patient1",
...
const appraisedValues = [
  345, 3456, 4356, 345, 476, 578, 234, 578, 678, 25, 567, 58, 578, 9, 99, 77,
];
...
class CreatePatientWorkload extends WorkloadModuleBase {
  ...
  async submitTransaction() {
    ...
    let appraisedValue =
      appraisedValues[Math.floor(Math.random() * appraisedValues.length)];
